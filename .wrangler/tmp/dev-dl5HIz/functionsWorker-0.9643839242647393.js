...
// .wrangler/tmp/pages-ydd6hR/functionsWorker-0.9643839242647393.mjs
...
__name2(sanitizeHtml, "sanitizeHtml");
function isoDateValid(v) {
  return /^\d{4}-\d{2}-\d{2}$/.test(v) && !Number.isNaN(Date.parse(v));
}
__name(isoDateValid, "isoDateValid");
__name2(isoDateValid, "isoDateValid");
...
__name2(sanitizeI18n, "sanitizeI18n");
...
__name2(rowToAdminItem, "rowToAdminItem");
...
__name2(rowToPublicItem, "rowToPublicItem");
...
__name(handleCors2, "handleCors2");
__name2(handleCors2, "handleCors");
...
__name(sanitizeHtml2, "sanitizeHtml2");
__name2(sanitizeHtml2, "sanitizeHtml");
function isoDateValid2(v) {
  return /^\d{4}-\d{2}-\d{2}$/.test(v) && !Number.isNaN(Date.parse(v));
}
__name(isoDateValid2, "isoDateValid2");
__name2(isoDateValid2, "isoDateValid");
...
__name(parseI18n2, "parseI18n2");
__name2(parseI18n2, "parseI18n");
...
__name(sanitizeI18n2, "sanitizeI18n2");
__name2(sanitizeI18n2, "sanitizeI18n");
...
__name(rowToAdminItem2, "rowToAdminItem2");
__name2(rowToAdminItem2, "rowToAdminItem");
...
__name(rowToPublicItem2, "rowToPublicItem2");
__name2(rowToPublicItem2, "rowToPublicItem");
...
// .wrangler/tmp/bundle-N9twMG/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-N9twMG/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9643839242647393.js.map
